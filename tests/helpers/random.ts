...
import { ComplexNumber, MobiusTransformation, UpperHalfPlanePoint } from "../../src/types";
...
export const randomNonZeroComplex = (upperBound: number = 1e5): ComplexNumber => {
  let z: ComplexNumber;
...
export const randomUpperHalfPlanePoint = (upperBound: number = 1e5): UpperHalfPlanePoint => {
  let z: ComplexNumber;
